...
class SteveJobsVoiceGenerator:
    ...
    def generate_audio(self, text_to_speech):
    ...
    def stream_text_to_speech(self, text_to_speech):
        audio = self.generate_audio(text_to_speech)
        return stream(audio)

    def play_text_to_speech(self, text_to_speech):
        audio = self.generate_audio(text_to_speech)
        return play(audio)

    def save_text_to_speech(self, text_to_speech):
        audio = self.generate_audio(text_to_speech)
